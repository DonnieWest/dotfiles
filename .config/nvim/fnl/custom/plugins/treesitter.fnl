...
(fn colorscheme-fixes []
  (let [italic-groups ["@comment"
    ...
    (merge-and-set-hl :Pmenu {:fg "#e6f9f7" :bg "#0c2132"})
    (merge-and-set-hl :PmenuSel {:fg "#e6f9f7" :bg "#0e3a4f"})
    (merge-and-set-hl :PmenuSbar {:bg "#0c2132"})
    (merge-and-set-hl :PmenuThumb {:bg "#1e425a"})
    (merge-and-set-hl :BlinkCmpMenu {:fg "#e6f9f7" :bg "#0c2132"})
    (merge-and-set-hl :BlinkCmpMenuSelection {:fg "#e6f9f7" :bg "#0e3a4f"})
    (merge-and-set-hl :BlinkCmpScrollBarGutter {:bg "#0c2132"})
    (merge-and-set-hl :BlinkCmpScrollBarThumb {:bg "#1e425a"})
