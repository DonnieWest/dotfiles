...
(defn colorscheme-fixes []
  ...
  (run-ex hi :TSKeywords :gui=italic)
  (run-ex hi :TSKeyword :gui=italic)
  (run-ex hi :TSStatement :gui=italic)
  (run-ex hi :TSBoolean :gui=italic)
  (run-ex hi :TSConstant :gui=italic)
  (run-ex hi :TSInclude :gui=italic)

  (run-ex hi :SpellBad :gui=underline)
  (run-ex hi :SpellLocal :gui=underline)
  (run-ex hi :SpellRare :gui=underline)
  (run-ex hi :htmlArg :gui=italic)
  (run-ex hi :Comment :gui=italic)
  (run-ex hi :Type    :gui=italic)
  (run-ex hi :Keywords :gui=italic)
  (run-ex hi :Keyword :gui=italic)
  (run-ex hi :Statement :gui=italic)
  (run-ex hi :Boolean :gui=italic)
  (run-ex hi :Constant :gui=italic)
  (run-ex hi :Include :gui=italic)
